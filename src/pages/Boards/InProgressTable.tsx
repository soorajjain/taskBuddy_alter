...
const InProgressTable = ({
  ...
  return (
    <div className="mb-8 w-[30vw]">
      {/* Section Header */}
      <div className="bg-[#85D9F1] p-2 rounded-t-lg w-full">
        <div className="flex justify-between items-center">
          <span className="font-semibold">IN-PROGRESS ({tasks.length})</span>
      ...
      {tableVisibility && (
        <Droppable droppableId="in-progress-tasks">
          {(provided) => (
            <div ref={provided.innerRef} {...provided.droppableProps} className="bg-[#f1f1f1]">
       
          

              {/* Tasks List as Cards */}
              <div className="space-y-2 p-4 bg-[#f1f1f1] h-screen rounded-b-lg">
              {tasks.length === 0 && (
